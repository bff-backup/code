import { ConfigurationVariable, LogLevel, logLevelFromJSON } from '@undergraph-dev/protobuf';
...
export const Logger = logger.child({ component: '@undergraph-dev/sdk' });
export const ServerLogger = logger.child(
	{ component: '@undergraph-dev/server', ...cloudBindings },
...
export const FatalLogger = initLogger(process.stderr).child({ component: '@undergraph-dev/sdk' });
