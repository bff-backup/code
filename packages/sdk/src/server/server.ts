...
import { ORM } from '@bff-backup/orm';
...
import { EngineConfiguration, InternedString, WunderGraphConfiguration } from '@bff-backup/protobuf';
import { ConfigurationVariableKind, DataSourceKind } from '@bff-backup/protobuf';
