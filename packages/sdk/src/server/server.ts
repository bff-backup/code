...
import { ORM } from '@undergraph-dev/orm';
...
import { EngineConfiguration, InternedString, WunderGraphConfiguration } from '@undergraph-dev/protobuf';
import { ConfigurationVariableKind, DataSourceKind } from '@undergraph-dev/protobuf';
